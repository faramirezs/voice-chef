...
- Current state: the code is frozen. The last commit on `main` is from 2026-05-10 and the last push to the repository was 2026-05-12. The repository is public and not archived. 41 issues and 3 pull requests are open, and many of them describe features that were never built.
