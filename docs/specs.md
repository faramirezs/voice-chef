...
2. [System Architecture](#2-system-architecture)
  1. [High-Level Overview](#21-high-level-overview)
  2. [Tech Stack](#22-tech-stack)
  3. [Deployment Model](#23-deployment-model)
3. [Agent Architecture](#3-agent-architecture)
  1. [Current State (Schema 011)](#31-current-state-schema-011)
  2. [MVP Behavior](#32-mvp-behavior)
  3. [Planned Agent Data Model (Post-MVP)](#33-planned-agent-data-model-post-mvp)
4. [Voice Pipeline](#4-voice-pipeline)
  1. [Hardware](#41-hardware)
  2. [Voice Flow (MVP)](#42-voice-flow-mvp)
  3. [Activation](#43-activation)
  4. [Output](#44-output)
  5. [Error Handling](#45-error-handling)
  6. [Concurrency](#46-concurrency)
  7. [Latency Target](#47-latency-target)
  8. [Later Voice Scope](#48-later-voice-scope)
5. [Frontend Specification](#5-frontend-specification)
  1. [Design Principles](#51-design-principles)
  2. [Core Views](#52-core-views)
  3. [Authentication](#53-authentication)
  4. [Offline Capability](#54-offline-capability)
  5. [Real-Time Updates](#55-real-time-updates)
6. [Data Model (Current Schema 011)](#6-data-model-current-schema-011)
  1. [Current Database Objects](#61-current-database-objects)
  2. [Schema Agreement Matrix (Current vs MVP Runtime)](#62-schema-agreement-matrix-current-vs-mvp-runtime)
  3. [Schema 011 Cross-Check Table (Detailed)](#63-schema-011-cross-check-table-detailed)
7. [API Specification](#7-api-specification)
  1. [REST API (FastAPI)](#71-rest-api-fastapi)
  2. [WebSocket Protocol](#72-websocket-protocol)
8. [AI Chat / Command Palette](#8-ai-chat--command-palette)
  1. [Interface Design](#81-interface-design)
  2. [Example Interactions](#82-example-interactions)
  3. [LLM Tool Calling](#83-llm-tool-calling)
9. [Cost Calculation Model](#9-cost-calculation-model)
  1. [Later Scope](#91-later-scope)
  2. [Configuration](#92-configuration)
10. [Internationalization (i18n)](#10-internationalization-i18n)
  1. [Strategy](#101-strategy)
  2. [Default Languages (MVP)](#102-default-languages-mvp)
...
12. [Migration Plan](#12-migration-plan)
  1. [Source](#121-source)
  2. [Implementation Files](#122-implementation-files)
  3. [Migration Steps](#123-migration-steps)
  4. [Key Design Decisions](#124-key-design-decisions)
